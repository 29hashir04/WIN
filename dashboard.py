...
class IMS:
    def __init__(self, root):
        ...
        # footer
        lbl_footer = Label(self.root, text="Workforce Information Network | Developed by Eesha, Hashir and Shajia\n For more info Contact: +92 3320208649",font=("times new roman", 15), bg="#4d636d", fg="white").pack(side = BOTTOM, fill = X)
