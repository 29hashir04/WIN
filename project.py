        ...
        try:
            ...
            cur.execute("""
                ...
                BEGIN
                    ...
                    INSERT INTO project_backup (pid, Customer, category, name, stipend, length, status, client)
                    SELECT OLD.pid, OLD.Customer, OLD.category, OLD.name, OLD.stipend, OLD.Length, OLD.status, OLD.client;
                END;
            """)
